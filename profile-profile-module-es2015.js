...
ProfileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProfileComponent, selectors: [["app-profile"]], decls: 14, vars: 0, consts: [[1, "blog"], [1, "about"], ["src", "assets/afif-min.jpg", "alt", "afifalfiano", 1, "myProfile"], [1, "introduction"], [1, "new"]], template: function ProfileComponent_Template(rf, ctx) { if (rf & 1) {
